...
const CATEGORY_CONFIG = {
  dating: {
    ...
    traits: ['Charismatic', 'Ambitious', 'Genuine'],
  ...
  fitness: {
    ...
    traits: ['Disciplined', 'Dedicated', 'Strong'],
  ...
  talent: {
    ...
    traits: ['Creative', 'Skilled', 'Passionate'],
    requirement: (city) => `Based in ${city}`,
  },
  business: {
    ...
    traits: ['Driven', 'Innovative', 'Strategic'],
    requirement: (city) => `Based in ${city}`,
  },
  pageant: {
    ...
    traits: ['Elegant', 'Poised', 'Talented'],
    requirement: (city) => `Based in ${city}`,
  },
  health: {
    ...
    traits: ['Balanced', 'Energetic', 'Mindful'],
    requirement: (city) => `Based in ${city}`,
  },
  social: {
    ...
    traits: ['Engaging', 'Authentic', 'Creative'],
    requirement: (city) => `Based in ${city}`,
  },
  default: {
    ...
    traits: ['Charismatic', 'Driven', 'Authentic'],
    requirement: (city) => `Based in ${city}`,
  },
};

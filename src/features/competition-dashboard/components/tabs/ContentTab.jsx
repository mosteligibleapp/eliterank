...
import { AboutSectionEditor, OrganizationBrandingEditor, NominationFormEditor } from '../settings';
...
export default function ContentTab({
  ...
  return (
    <div>
      ...
      {/* Nomination Form Creator */}
      <NominationFormEditor competition={competition} onSave={onRefresh} />

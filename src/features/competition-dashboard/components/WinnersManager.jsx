  ...
  if (loading) {
    return (
      <div style={{
        ...
        <SkeletonPulse height="40px" style={{ marginBottom: spacing.lg }} />
        {Array.from({ length: 5 }, (_, i) => (
          <div key={i} style={{ display: 'flex', gap: spacing.md, marginBottom: spacing.md, alignItems: 'center' }}>
            <SkeletonCircle size="40px" />
            <SkeletonPulse height="16px" style={{ flex: 1 }} />
            <SkeletonPulse height="16px" width="80px" />
          </div>
        ))}
      </div>
    );

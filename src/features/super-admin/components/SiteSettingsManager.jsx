...
import {
  Trophy, Plus, Trash2, Loader, User, Save, GripVertical, Search, X, Check
} from 'lucide-react';
...
export default function SiteSettingsManager() {
  ...
  const [formData, setFormData] = useState({
    ...
    totalAwarded: '$75K+',
    winners: [],
    displayOnCompetitions: [], // Array of competition IDs to also display these winners on
  });
  ...
  // Competitions list for multi-select
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: spacing.md }}>
            ...
            <div>
              ...
              <p style={{ fontSize: typography.fontSize.sm, color: colors.text.secondary }}>
                Showcase past champions on the explore page and competition pages
              </p>
            </div>
          </div>
          <Button
        ...
        <div style={{ padding: spacing.lg }}>
          ...
          <div style={{ marginTop: spacing.xl }}>
            <label style={{
              ...
              Also display on these competition pages (Coming Soon & Nominations phases)
            </label>
            <p style={{
              fontSize: typography.fontSize.xs,
              color: colors.text.muted,
              ...
              Select competitions to show these winners beneath the "Who Competes?" section
            </p>
                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        gap: spacing.md,
                        padding: spacing.md,
                        background: isSelected ? colors.gold.muted : colors.background.primary,

...
const variants = {
  ...
  success: {
    ...
    activeBackground: 'var(--color-success-dark)',
  },
  danger: {
    ...
    activeBackground: 'var(--color-error-dark)',
  },
  ...
  approve: {
    ...
    hoverBackground: 'rgba(var(--color-success-rgb), 0.25)',
    activeBackground: 'rgba(var(--color-success-rgb), 0.35)',
  },
  reject: {
    background: colors.status.errorMuted,
    color: colors.status.error,
    border: `1px solid rgba(var(--color-error-rgb), 0.3)`,
    hoverBackground: 'rgba(var(--color-error-rgb), 0.25)',
    activeBackground: 'rgba(var(--color-error-rgb), 0.35)',
  },
  purple: {

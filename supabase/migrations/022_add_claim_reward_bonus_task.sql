-- =============================================================================
-- Add claim_reward bonus vote task
-- Awards bonus votes when contestants claim an active reward
-- =============================================================================
...
SELECT DISTINCT
  competition_id,
  'claim_reward',
  'Claim an active reward',
  'Claim one of the rewards available to you in this competition',
  20,
  8
...
BEGIN
  ...
  VALUES
    ...
    (p_competition_id, 'claim_reward', 'Claim an active reward', 'Claim one of the rewards available to you in this competition', 20, 8)
  ON CONFLICT (competition_id, task_key) DO NOTHING;
END;

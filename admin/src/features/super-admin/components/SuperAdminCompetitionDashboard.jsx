...
import { EventModal, AddPersonModal, AnnouncementModal } from '@shared/components/modals';

// Import host dashboard components for reuse
import RevenueCard from '@shared/features/overview/components/RevenueCard';
import HostPayoutCard from '@shared/features/overview/components/HostPayoutCard';
import CurrentPhaseCard from '@shared/features/overview/components/CurrentPhaseCard';
import TrafficCard from '@shared/features/overview/components/TrafficCard';
import UpcomingCard from '@shared/features/overview/components/UpcomingCard';
import Leaderboard from '@shared/features/overview/components/Leaderboard';
import WinnersManager from '@shared/features/competition-dashboard/components/WinnersManager';
import TimelineSettings from '@shared/features/competition-dashboard/components/TimelineSettings';

// Import the real data hook
import { useCompetitionDashboard } from '@shared/features/competition-dashboard/hooks/useCompetitionDashboard';
